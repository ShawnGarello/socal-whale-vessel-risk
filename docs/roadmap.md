...
- An authorized fresh run at source commit `c32e706` reverified all five raw AIS
  files, spatial archives/tree and immutable VSR snapshot; regenerated byte-exact
  water, whale and analytical-domain outputs; and freshly processed July through
